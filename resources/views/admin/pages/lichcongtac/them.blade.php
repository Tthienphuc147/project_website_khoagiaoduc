...
<div class="main-content">
    ...
    <div class="container">
        <h3 class="pb-3">Thêm tuần công tác</h3>
        <div class="row">
          <div class="col-12">
            <div class="card">
                ...
                <div class="card-body card-block">
                    <form action="quantri/lichcongtac/them" method="post" enctype="multipart/form-data" class="form-horizontal">
                    {{csrf_field()}}
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                            <textarea type="input"  name="noi_dung" id="demo" placeholder="Nội dung lịch công tác tuần" class="form-control"  required></textarea>
